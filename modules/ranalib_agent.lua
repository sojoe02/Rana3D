...
function ranaLibAgent.addAgent(filename, posX, posY, posZ)
	...
	local posZ = posZ or l_getRandomInteger(1,mapWidth)
	
	if type(filename) == "string" then
		local ID = l_addAgent(posX, posY, posZ, path, filename)
		return ID
	else 
